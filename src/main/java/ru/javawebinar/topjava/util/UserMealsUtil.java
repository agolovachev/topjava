...
//            LocalDate mealTime = userMeal.getDateTime().toLocalDate();
//            totalCaloriesPerDayMap.put(mealTime, totalCaloriesPerDayMap.getOrDefault(mealTime, 0) + userMeal.getCalories() );
//        }
//
...
//                userMealWithExceedList.add(new UserMealWithExceed(dateTime, userMeal.getDescription(),
//                        userMeal.getCalories(), totalCaloriesPerDayMap.get(dateTime.toLocalDate()) > caloriesPerDay));
//            }
//        }
